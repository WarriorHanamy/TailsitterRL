...
from ..policies.sac_polices import MultiInputPolicy
...
class SAC(sb_SAC):
    ...
    def __init__(self, comment="", save_path=None, scene_freq=None, *args, **kwargs):
        ...
        self.policy_save_path = (
            f"{self.save_path}/PPO_{self.comment}"
            if comment is not None
            else f"{self.save_path}/ppo"
        )
