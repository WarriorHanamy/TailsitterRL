...
class CustomMultiInputActorCriticPolicy(MultiInputActorCriticPolicy):
    ...
    def __init__(
        ...
        if features_extractor_class is None:
            assert (
                pi_features_extractor_class is not None
                and vf_features_extractor_class is not None
            )
            ...
            assert (
                pi_features_extractor_class is None
                and vf_features_extractor_class is None
            )
        ...
        if hasattr(self.features_extractor, "recurrent_extractor"):
            self.mlp_extractor.policy_net[0] = nn.Linear(
                self.features_extractor.recurrent_extractor.hidden_size,
                self.mlp_extractor.policy_net[0].out_features,
            )
            self.mlp_extractor.value_net[0] = nn.Linear(
                self.features_extractor.recurrent_extractor.hidden_size,
        ...
        if (
            ...
            self.pi_features_extractor = pi_features_extractor_class(
                observation_space, **pi_features_extractor_kwargs
            )
            self.pi_features_dim = self.pi_features_extractor.features_dim
            self.vf_features_extractor = vf_features_extractor_class(
                observation_space, **vf_features_extractor_kwargs
            )
            ...
            raise ValueError(
                "Invalid combination of features_extractor_class, pi_features_extractor_class and vf_features_extractor_class"
            )
    ...
    def _build_mlp_extractor(self) -> None:
        if not hasattr(self, "pi_features_dim") and not hasattr(
    ...
    def forward(
        self, obs: th.Tensor, deterministic: bool = False, latent: th.Tensor = None
    ...
    def get_distribution(
        self, obs: PyTorchObs, latent: th.Tensor = None
    ) -> Distribution:
        """
